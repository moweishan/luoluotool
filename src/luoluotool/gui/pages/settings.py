...
class SettingsPage(ScrollablePage):
    ...
    def set_config(self, config: AppConfig) -> None:
        ...
        self.developer_box.blockSignals(True)
        self.developer_box.setChecked(automation.developer_mode)
        self.developer_box.blockSignals(False)
    ...
    def _on_developer_toggled(self) -> None:
        self._config.automation.developer_mode = self.developer_box.isChecked()
        self._on_changed()
